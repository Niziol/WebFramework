...
var UserForm = /*#__PURE__*/function (_View_1$View) {
  ...
  function UserForm() {
    ...
    _this.template = function () {
      return "\n    <div>\n      <input placeholder=\"".concat(_this.model.get('name'), "\" />\n      <button class=\"set-name\">Update name</button>\n      <button class=\"set-age\">Set Random Age</button>\n      <button class=\"save-model\">Save</button>\n    </div>\n    ");
    };
    return _this;
  }
...
var UserEdit = /*#__PURE__*/function (_View_1$View) {
  ...
  function UserEdit() {
    ...
    _this.onRender = function () {
      new UserShow_1.UserShow(_this.regions.userShow, _this.model).render();
      new UserForm_1.UserForm(_this.regions.userForm, _this.model).render();
    };
    return _this;
  }
...
},{"./views/UserEdit":"src/views/UserEdit.ts","./models/User":"src/models/User.ts"}],"../../../Users/nizio/AppData/Roaming/npm/node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
var global = arguments[3];
